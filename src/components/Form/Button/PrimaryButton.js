const PrimaryButton = ({
    ...
    const initCn = 'inline-flex items-center justify-center font-bold bg-gray-900 hover:bg-gray-700 text-white hover:text-white text-sm rounded-full shadow-md';
